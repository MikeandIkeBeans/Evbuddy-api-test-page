...
def get_all_businesses():
    """List all businesses."""
    return proxy_json_request("GET", f"{EVBUDDY_DEV_BUSINESS_BASE}/businesses",
...
def get_business(business_id):
    ...
    return proxy_json_request("GET", f"{EVBUDDY_DEV_BUSINESS_BASE}/businesses/{business_id}",
...
def create_business():
    ...
    if err:
        return err
    return proxy_json_request("POST", f"{EVBUDDY_DEV_BUSINESS_BASE}/businesses",
...
def update_business(business_id):
    ...
    if err:
        return err
    return proxy_json_request("PUT", f"{EVBUDDY_DEV_BUSINESS_BASE}/businesses/{business_id}",
...
def delete_business(business_id):
    """Delete a business."""
    return proxy_json_request("DELETE", f"{EVBUDDY_DEV_BUSINESS_BASE}/businesses/{business_id}",
